...
const PassportApplicationApprovalPanel = ({ adminData }) => {
  ...
  const handleApprove = async (adminData) => {
    ...
    try {
      await fetch(
        import.meta.env.VITE_EDGE_FUNCTION_APPROVE_REJECT_PASSPORT_APPLICATION,
        {
          method: "POST",
          headers: {
          ...
          body: JSON.stringify({
            application_submission_id: record.id,
            action: "approve",
      ...
      navigate("/accepted_application_submission_view");
  ...
  const handleReject = async () => {
    ...
    try {
      await fetch(import.meta.env.VITE_EDGE_FUNCTION_APPROVE_REJECT_PASSPORT_APPLICATION, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          authorization: `Bearer ${import.meta.env.VITE_SUPABASE_API_KEY}`,
      ...
      navigate("/rejected_application_submission_view");
...
export default PassportApplicationApprovalPanel;
